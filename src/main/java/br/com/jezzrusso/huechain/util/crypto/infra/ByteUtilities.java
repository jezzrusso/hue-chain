package br.com.jezzrusso.huechain.util.crypto.infra;
...
public class ByteUtilities {
	 ...
	 * @param size
	 *            The final desired size of the data.
	 * @param pad
	 *            The byte value to use in padding the data.
	...
	/**
	 * Reads a section of a byte array and returns it as its own byte array, not
	 * unlike a substring.
	 *
	 * @param data
	 *            Byte array to read from.
	 * @param start
	 *            Starting position of the desired data.
	 * @param size
	 *            Size of the data.
